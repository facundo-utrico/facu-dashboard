          ...
          <div class="row">
            ...
            <h1>Search Items</h1>
					  <div class="card-header card-header-primary">
						<h4 class="card-title">Use the search bar to search and edit ITEMS.</h4>
						<p class="card-category">Search by: <br>
							<form action="" name="search">
								...
								<label style="color: #000; font-size: 15px;"><input type="radio" name="filter" onclick="searchname()" value="3"> Item code</label><br>
...
function searchname(){ //Agrega inputs segun cantidad de ocupantes totales
  document.getElementById('inputSearch').innerHTML = "<div class='form-group bmd-form-group'><input placeholder='Search Item' style='color: #000;' onkeyup='showResultsNAME(this.value)' type='text' name='nameProp' class='form-control' required='' id='inputProp'></div>";
  document.getElementById("inputProp").focus();
}
...
function showResultsNAME(str) {
    ...
    xmlhttp.open("GET", "../search/searchItemResulte.inc.php?fr=name&q=" + str, true);
    xmlhttp.send();
